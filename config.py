...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002374182046"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://madarazbotz:Squ7qrKySvxFVpuD@cluster0.cjp2q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
#start message
START_PIC = os.environ.get("START_PIC","https://telegra.ph/file/1dff3bd1a4e8776b64f44.jpg")
